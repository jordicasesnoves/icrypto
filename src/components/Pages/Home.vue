<template>
  <div class="w-full max-w-7xl mx-auto h-screen bg-gray-100">
    <div class="xs:px-8 lg:px-16">
      ...
      <div class="mt-16 block lg:flex justify-between lg:h-24">
        <div class="lg:flex lg:flex-col lg:justify-between xs:my-6 lg:my-0">
          ...
          <div class="text-3xl lg:mt-4 text-black font-medium">$3330.09</div>
        </div>
          ...
          <div class="xs:mt-4 lg:mt-0 relative h-12" v-if="!loading">
            <div v-for="(crypto,index) in cryptosFollowing" :key="crypto.id">
              <cryptoicon
                ...
                ref="icons"
                class="w-10 h-10 absolute border-4 border-gray-100 rounded-full inline align-middle"
          ...
          >
            <div class="p-6">
              <div class="flex justify-between flex-row">
                ...
                <div class="self-center">
                  <span class="pl-4 text-sm inline font-medium self-center">24h</span>
                </div>
              </div>
  ...
  methods: {
    setGraphColors() {
      this.$refs.icons.forEach((icon, index) => {
        ...
        let color =
          icon.$el.lastElementChild.childNodes["0"].attributes[3].nodeValue;
        // Set the graph color
