<template>
  <div class="flex">
    <div class="flex justify-betwen flex-row w-full xs:px-8 lg:px-16">
      <div class="mr-16 self-center">
        <h1 class="font-bold text-black text-2xl">iCrypto</h1>
      </div>
      <div class="flex-1">
        <div class="flex mr-4 h-full items-center">
          <div class="flex font-medium">
            <a href="#" class="inline text-indigo-600 border-b-2 border-indigo-600 py-6 mr-8 text-center">
              ...
              <span class="inline px-1 align-middle">Dashboard</span>
            </a>
            <a href="#" class="transition-normal inline border-b-2 border-transparent hover:border-gray-500 py-6 mr-8 text-center">
              <SvgIcon class="inline-block align-middle">
                <path
                  class="icon"
              ...
              <span class="inline-block px-1 align-middle">Wallet</span>
            </a>
            <a href="#" class="transition-normal inline border-b-2 border-transparent hover:border-gray-500 py-6 mr-8 text-center">
              <SvgIcon class="inline-block align-middle">
                <path
              ...
              <span class="inline-block px-1 align-middle">Prices</span>
            </a>
            <a href="#" class="transition-normal inline border-b-2 border-transparent hover:border-gray-500 py-6 mr-8 text-center">
              <SvgIcon class="inline-block align-middle">
                <path
              ...
              <span class="inline-block px-1 align-middle">Profile</span>
            </a>
          </div>
        </div>
      </div>
      <div class="mr-4 self-center">
        <div
          class="cursor-pointer font-medium text-base rounded-lg bg-red-600 text-white w-full py-4"
        >
          <SvgIcon class="inline align-middle">
            <path
              class="heroicon-ui"
          ...
          <div class="px-2 inline align-middle">Log Out</div>
        </div>
      </div>
    </div>
  </div>
...
nav {
  ...
  //border-right: 1px solid var(--bg-accent-color);
  width: 17rem;
}
